...
This is a sample template for event-handler - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name event-handler --query 'Stacks[].Outputs'
```
